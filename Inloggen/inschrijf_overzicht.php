  ...
  <main>
        ...
        <div class="container row jc-center">
          <div class="main-menu">
            <ul>
              ...
              <!-- Link to the "Astronomie" page from any other page -->
              <li><a href="../Opleiding/opleiding.php">Opleiding</a></li>
              <!-- Link to the "Contact" page from any other page -->
              ...
              <!-- Link to the "Contact" page from any other page -->
              <li><a href="../Inloggen/inlog.php">Inschrijven</a></li>
              <!-- Link to the "Inschrijven" page from any other page -->
            </ul>
          </div>
        </div>
      </nav>
    ...
    <div id="banner">
      ...
      <div class="content text-center">
        ...
        <p>Inschrijfgegevens </p>
      </div>
      </img>
    </div>
    </header>

    <h3>Beste bezoeker alleen u ziet deze inschrijfgegevens </h3>
    ...
    <section class="overzicht">
      <table class="table table-dark table-striped">
        ...
        <a href="overzicht.php">Contactoverzicht</a>
        </div>
    </section>
  </main>
